...
{
    private readonly IDietaService
        _dietaService;
    ...
    {
        var resultado =
            await _dietaService.CrearAsync(
    ...
    {
        var resultado =
            await _dietaService.ObtenerTodasAsync(
                ObtenerUsuarioIdActual(),
                pacienteId
            );
    ...
    {
        var resultado =
            await _dietaService.ObtenerPorIdAsync(
                ObtenerUsuarioIdActual(),
                pacienteId,
                dietaId
            );
    ...
    {
        var resultado =
            await _dietaService.EditarAsync(
                ObtenerUsuarioIdActual(),
                pacienteId,
                dietaId,
                dto
    ...
    {
        var resultado =
            await _dietaService.ActivarAsync(
                ObtenerUsuarioIdActual(),
                pacienteId,
                dietaId
            );
    ...
    {
        var resultado =
            await _dietaService.ArchivarAsync(
                ObtenerUsuarioIdActual(),
                pacienteId,
                dietaId
            );
